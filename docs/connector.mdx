...
- **Status** — Active or Inactive. Inactive keys are reported as disabled and synced rather than skipped because they still exist and can be reactivated; reviewers decide whether to delete them.
