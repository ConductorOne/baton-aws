...
Flags:
  ...
  -f, --file string                         The path to the c1z file to sync with ($C1_FILE) (default "sync.c1z")
      ...
      --use-assume-role                     Enable support for assume role. ($BATON_GLOBAL_USE_ASSUME_ROLE)
      --external-id                         The external id for the aws account. ($BATON_EXTERNAL_ID)
      --role-arn                            The role arn for the aws account. ($BATON_ROLE_ARN)
